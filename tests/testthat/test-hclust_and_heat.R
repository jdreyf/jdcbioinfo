...
test_that("default", {
  ...
  expect_equal(rownames(clus_df)[1:3], c("gene4", "gene18", "gene40"))
...
test_that("deepSplit=2", {
  ...
  expect_equal(rownames(clus_df)[1:3], c("gene8", "gene25", "gene47"))
...
test_that("clip=1", {
  ...
  expect_equal(rownames(clus_df)[1:3], c("gene98", "gene23", "gene91"))
